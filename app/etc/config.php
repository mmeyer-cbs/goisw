...
return [
    'modules' => [
        ...
        'Bss_CatalogPermission' => 1,
        'Bss_QuoteExtension' => 1,
        'Bss_SalesRep' => 1,
        'Bss_CompanyCredit' => 1,
        'Bss_MultiWishlist' => 1,
        'Bss_CustomPricing' => 1,
        'Bss_CustomPricingGraphQl' => 1,
        'Bss_CustomerAttributes' => 1,
        'Bss_FastOrder' => 1,
        'Bss_B2bRegistrationGraphQl' => 1,
        'Bss_HidePrice' => 1,
        'Bss_B2bPorto' => 1,
        'Bss_MultiWishlistGraphQl' => 1,
        'Bss_OrderAmount' => 1,
        'Bss_Paymentshipping' => 1,
        'Bss_CompanyAccount' => 1,
        'Bss_ReorderProduct' => 1,
        'Bss_ReorderProductGraphQl' => 1,
        'Bss_CompanyAccountGraphQl' => 1,
        'Bss_StoreCredit' => 1,
        'Bss_StoreCreditGraphQl' => 1,
        'Mageplaza_Core' => 1,
