 ...
 */
namespace Bss\CatalogPermission\Model\Category\Attribute\Backend;
 ...
 * Class CustomBackend
 *
 * @package Bss\CatalogPermission\Model\Category\Attribute\Backend
 */
class CustomBackend extends AbstractBackend
{
    ...
    public function beforeSave($object)
    {
        ...
        if ($attributeCode == 'bss_customer_group') {
    ...
    private function getBssCustomerGroup($data)
    {
        ...
        if (!empty($categoryPostData['use_default']['bss_customer_group'])) {
