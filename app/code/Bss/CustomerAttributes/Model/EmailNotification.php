...
class EmailNotification
{
    ...
    {
        if ($customer->getWebsiteId() != 0 && $defaultStoreId == null) {
    ...
    public function aroundNewAccount(
        ...
        $data['bss_customer_attributes'] = $this->helper->getVariableEmailNewAccountHtml($customer->getId(), $customer->getStoreId());
