...
class AttributeDependent extends AbstractModel implements AttributeInterface
{
    public const ID = 'id';
    ...
    {
        $this->_init(ResourceModel\Attribute\AttributeDependent::class);
    }
     ...
     *
     * @param mixed|int $id
     * @return \Bss\CustomerAttributes\Model\AttributeDependent
     */
