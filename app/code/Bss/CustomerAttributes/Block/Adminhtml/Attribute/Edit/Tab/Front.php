...
class Front extends Generic
{
    ...
    /**
     * @var DisplayBackendCustomerDetail
     */
    protected $displayBackendCustomerDetail;
     ...
     * @param DisplayBackendCustomerDetail $displayBackendCustomerDetail
    ...
    public function __construct(
        ...
        DisplayBackendCustomerDetail $displayBackendCustomerDetail,
        ...
        $this->displayBackendCustomerDetail = $displayBackendCustomerDetail;
    ...
    protected function _prepareForm()
    {
        ...
        $accountType = $this->displayBackendCustomerDetail->toOptionArray();
        ...
        $showOnRegistration = $this->checkShowAttribute(
            $attributeObject,
            $usedInForms,
            'customer_account_create_frontend'
        );
        if ($this->moduleManager->isEnabled('Bss_B2bRegistration')) {
            $showOnBbRegistrationDisplay = $this->checkShowAttributeDisplay(
                $attributeObject,
                $usedInForms
            );
            $fieldset->addField(
                'b2b_account_create_backend',
                'select',
                [
                    'name' => 'b2b_account_create_backend',
                    'label' => __('Display in backend customer detail page'),
                    'title' => __('Display in backend customer detail page'),
                    'values' => $accountType,
                    'value' => $showOnBbRegistrationDisplay,
                ]
            );
            $showOnBbRegistrationForm = $this->checkShowAttribute(
                $attributeObject,
                $usedInForms,
                'b2b_account_create'
            );
            $fieldset->addField(
                ...
                [
                    ...
                    'values' => $yesnoSource,
                    'value' => $showOnBbRegistrationForm,
                ]
            );
            $showOnBbRegistrationPage = $this->checkShowAttribute(
                $attributeObject,
                $usedInForms,
                'b2b_account_edit'
            );
            $fieldset->addField(
                ...
                [
                    ...
                    'values' => $yesnoSource,
                    'value' => $showOnBbRegistrationPage,
                ]
            );
        }
        $fieldset->addField(
        ...
        $showAccountEdit = $this->checkShowAttribute(
            $attributeObject,
            $usedInForms,
    ...
    /**
     * Check attribute display or not
     *
     * @param array|mixed $attributeObject
     * @param array|mixed $usedInForms
     * @return false|int|string
     */
    public function checkShowAttributeDisplay($attributeObject, $usedInForms)
    {
        if ($attributeObject->getAttributeId()) {
