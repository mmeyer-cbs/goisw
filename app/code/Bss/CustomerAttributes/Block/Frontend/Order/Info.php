...
class Info extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Magento\Sales\Block\Adminhtml\Order\View\Info $blockBe
     * @param array $data
     */
    public function __construct(
        ...
        Registry $registry,
        \Magento\Sales\Block\Adminhtml\Order\View\Info $blockBe,
        array $data = []
    ) {
        $this->helper = $helper;
        $this->sessionCustomer = $sessionCustomer;
        $this->coreRegistry = $registry;
        $this->blockBe=$blockBe;
    ...
    /**
     * Get CustomerAccountData
     */
    public function getCustomerAccountData()
    {
        return $this->blockBe->getCustomerAccountData();
    }
}
