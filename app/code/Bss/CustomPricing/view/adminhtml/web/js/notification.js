...
define([
    ...
    var bssSuccessMessage = {
        options: {
            templates: {
                bss_custom_pricing_request_success: '<div data-role="messages" id="messages">' +
        ...
        add: function (data) {
            if (data.bss_custom_pricing_request_success) {
                var template = this.options.templates.bss_custom_pricing_request_success,
