...
define([
    ...
    AdminOrder.prototype = {
        initialize : function(data){
            ...
            this.customerId     = jQuery("input[name=customer_id]").val();
            this.storeId        = data.store_id ? data.store_id : false;
            this.quote_id        = jQuery("input[name=quote_id]").val();
        ...
        setShippingMethodWithPrice: function (method, price) {
            var data = {};
            data['quote[shipping_method]'] = method;
            data['quote[quote_shipping_price]'] = price;
            this.loadArea(['shipping_method', 'totals', 'convert'], true, data);
        },
        ...
        productGridAddSelected : function(){
            ...
            var area = ['search', 'items', 'info', 'totals', 'giftmessage'];
        ...
        itemsUpdate : function(){
            var area = ['items', 'info', 'billing_method','totals', 'giftmessage'];
        ...
        productConfigureSubmit : function(listType, area, fieldsPrepare, itemsFilter) {
            ...
            fieldsPrepare.quote_id = jQuery("input[name=quote_id]").val();
        ...
        prepareParams : function(params){
            ...
            if (!params.quote_id) {
                params.quote_id = jQuery("input[name=quote_id]").val();
            }
