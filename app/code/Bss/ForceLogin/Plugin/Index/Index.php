 ...
 */
namespace Bss\ForceLogin\Plugin\Index;
...
class Index
{
    ...
    public function aroundExecute(\Magento\Checkout\Controller\Index\Index $subject, \Closure $proceed)
    {
        ...
        $enableCheckoutPage = $this->helperData->isEnableCheckoutPage();
        if ($enableLogin && $enableCheckoutPage) {
