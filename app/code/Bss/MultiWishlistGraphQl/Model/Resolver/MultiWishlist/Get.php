...
class Get implements ResolverInterface
{
     ...
     * @return MultiwishlistInterface[]|\Magento\Framework\Api\ExtensibleDataInterface[]
    ...
    public function resolve(
       ...
       return $this->multiWishlistRepository->getListByCustomerId($customerId);
    }
}
