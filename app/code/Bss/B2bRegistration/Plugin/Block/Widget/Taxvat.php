...
class Taxvat
{
     ...
     * Check if taxvat attribute enabled in system
     *
     * @param \Magento\Customer\Block\Widget\Taxvat $subject
     * @param $result
     * @return bool|mixed
     */
    public function afterIsEnabled(\Magento\Customer\Block\Widget\Taxvat $subject, $result)
    {
