...
class ConfigurableListingRenderer
{
    /**
     ...
     */
    public function afterGetPricesJson($subject, $result)
    {
        if ($this->helper->isEnable()) {
            ...
            if ($this->helper->activeHidePrice($product) && $this->helper->hidePriceActionActive($product) != 2) {
                ...
                $config['oldPrice']['amount'] = 0;
                $config['basePrice']['amount'] = 0;
                $config['finalPrice']['amount'] = 0;
